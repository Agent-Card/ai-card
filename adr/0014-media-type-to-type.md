...
- **Skills markdown**: We decided to go with the the `application/agent-skills+md`. (updated on 08/20/2026: Email sent for feedback on registering +md as structured suffix mailarchive.ietf.org/arch/msg/media-types/uzz7rt9wXPWSx5r66Ba2CKPkNsE)
